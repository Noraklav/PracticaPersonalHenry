function crearGato(nombre, edad) {
  ...
  function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso){
    ...
    // Tu código:
    let resultado = objetoMisterioso.numeroMisterioso*5; //*En la variable  
    return resultado;
  }
  ...
  function sumarLikesDeUsuario(usuario) {
    ...
    // Tu código:
    let suma = 0;
    for(let z=0;z<usuario.post.length;z++){
        suma = suma + usuario.post.likes[z];
    }
    return suma;
  }
  ...
  function agregarMetodoCalculoDescuento(producto) {
    ...
    // Tu código:
    //* No se resolverlo solo. No lo voy a hacer.
  }